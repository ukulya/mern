                ...
                <div className="card p-3">
                    <div className="card-content">
                        ...
                        <div className="form-group mb-3">
                            ...
                            <input type="email" placeholder="Введите почту" id="email" name="email" className="form-control" onChange={onC}/>
                        </div>
                        <div className="form-group mb-3">
                            <label htmlFor="password" className="control-label">Введите пароль</label>
                            <input type="password" placeholder="Введите пароль" id="password" name="password" className="form-control" onChange={onC}/>
                        </div>
                    </div>
