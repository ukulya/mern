            ...
            <div className="col-lg-6">
                ...
                <div className="card p-3">
                    ...
                    <div className="card-acion">
                        <button className="btn btn-primary me-3" onClick={loginHandler} disa>Войти</button>
                        <button className="btn btn-secondary" onClick={registerHandler} disa>Регистрация</button>
                    </div>
                </div>
            </div>
        </div>
